package com.health.immunity.expertchat;
...
import com.health.immunity.databinding.FragmentExpertChatBinding;
 ...
 */
public class ExpertChatFragment extends Fragment implements IActFragment {

    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    FragmentExpertChatBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      //  return inflater.inflate(R.layout.fragment_expert_chat, container, false);
        ...
        System.out.println("Expert Chat Fragment entered");
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_expert_chat, container, false);
