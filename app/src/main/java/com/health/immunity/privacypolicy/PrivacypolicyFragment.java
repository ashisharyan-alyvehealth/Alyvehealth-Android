package com.health.immunity.privacypolicy;
...
import com.health.immunity.databinding.FragmentPrivacypolicyBinding;
 ...
 */
public class PrivacypolicyFragment extends Fragment implements IActFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        presenter.getUrlFromSourceAPI(webView, PreferenceHelper.getStringPreference(context, IConstant.TOKEN),995);
        return view;
    }
