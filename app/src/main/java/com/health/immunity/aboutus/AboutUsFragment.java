package com.health.immunity.aboutus;
...
import com.health.immunity.databinding.FragmentAboutUsBinding;
 ...
 */
public class AboutUsFragment extends Fragment implements IActFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // return inflater.inflate(R.layout.fragment_about_us, container, false);
        System.out.println("About Us Fragment entered");
        ...
        presenter.getUrlFromSourceAPI(webView, PreferenceHelper.getStringPreference(context, IConstant.TOKEN),999);
        return view;
    }
