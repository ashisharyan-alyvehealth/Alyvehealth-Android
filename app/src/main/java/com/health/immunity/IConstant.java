...
//  String CAL_URL="https://protect-alyve-health.netlify.app/local-calendar/calendar/";
 ...
 //   String IMAGE_BASE_URL = "http://demo31.laraveldevloper.in/assets/user_images/";
    ...
    String FAILUREe = "Failuree";
    String SERVER_ERROR = "Server Error!";
    String INTERNET_AVAIL = "Please Check Internet Connection";
    String SOME_WRONG = "Something went wrong";
    String PER_DENIED = "Permission denied";
    String PER_GRANTED = "Permission Granted";
    String VERIFY_USERS = "Please wait verifying user";
    String COMMON_MSG = "Please wait";
    String FCM_TOKEN = "fcm_token";
    String MY_FCM_TOKEN = "my_fcm_token";
    String IS_LOGIN = "is_login";
    String IS_CHECKIN = "is_checkin";
    String IS_Blue_chck = "isblue_checkin";
    String IS_TIME_CHECK = "is_time_checkin";
    String IS_AUTOCHECKIN = "is_autocheckin";
    String IS_ONBOARD = "is_onboard";
    String IS_HR_ONBOARD = "is_hr_onboard";
    String IS_FIT = "is_fit";
    String IS_LANG = "is_lang";
    String TOKEN = "token";
    String EMAILACT = "email";
    String MOBILEACT = "mobile";
    String API_KEY_WEATHER = "apikey";
    String FIT_STATUS_BACK = "fit_status";
    String PEDO_STATUS_BACK ="pedo_status";
    String FIT_PEDOMETER = "fit_pedo";
    String PERSONAL_EMAIL_ADD = "email_add";
    String FIT_URL_BACK = "key_back";
    String IS_VERIFIEDUSER = "isverified";
    String GEOLAT = "geolat";
    String GEOLATOFF = "geolat";
    String GEOLONG = "geolong";
    String GEOLONGOFF = "geolong";
    String AUTOCHECKIN = "auto";
    String ACCESSCONTROL = "access";
    String TIMEDIFFERENCE = "timediff";
    ...
    String PLZ_WAIT = "Please wait!";
    String CANCEL = "Cancel";
    String OKAY = "OK";
    String RETRY = "Please Retry";
    String NO_DATA_FOUND = "No Data Found!";
    String DEFAULT_IMAGE = "https://pngimage.net/wp-content/uploads/2018/05/default-profile-pic-png-8.png";
    int CAMERA_REQUEST_CODE = 121;
    int LOCATION_REQUEST_CODE = 123;
    int ADDRESS_CAPTURE = 22;
    int ADDRESS_CAPTURE2 = 222;
    String MY_DATE_FORMAT = "dd-MM-yyyy";
    String MY_DATE_FORMAT_PROFILE = "dd-MMM-yyyy";
    String OTHER = "other";
    String API_KEY  = "AIzaSyDmkurT9uAHLe9dlq7XP9GcWXrvJ2YzQ1c";
  // String API_KEY  = "AIzaSyDmkurT9uAHLe9dlq7XP9GcWXrvJ2YzQ1c";
  //  String API_KEY  = "AIzaSyDhMI_GRiG9qLlD5qUwvC4_BiVmOOu3LGo";
