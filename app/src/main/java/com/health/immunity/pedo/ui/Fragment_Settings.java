 ...
 */
package com.health.immunity.pedo.ui;
...
import com.health.immunity.pedo.SensorListener;
import com.health.immunity.pedo.util.API23Wrapper;
import com.health.immunity.pedo.util.API26Wrapper;
import com.health.immunity.pedo.util.PlaySettingsWrapper;
...
public class Fragment_Settings extends PreferenceFragment implements OnPreferenceClickListener {
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        PlaySettingsWrapper
                .setupAccountSetting(account, savedInstanceState, (HomeActivity) getActivity());
    ...
    public void onSaveInstanceState(final Bundle outState) {
        ...
        PlaySettingsWrapper.onSavedInstance(outState, (HomeActivity) getActivity());
    }
