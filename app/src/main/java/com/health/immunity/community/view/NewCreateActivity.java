...
import com.health.immunity.databinding.ActivityNewCreateBinding;
...
public class NewCreateActivity extends BaseActivity {
    ActivityNewCreateBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(activity, R.layout.activity_new_create);
    ...
    private void initViews() {
        ...
        binding.ivcreate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    showToast("Please enter community description");
        ...
        usercommApi(getIntent().getStringExtra("mycomid"));
    ...
    private void showContacts() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && checkSelfPermission(Manifest.permission.READ_CONTACTS) != PackageManager.PERMISSION_GRANTED) {
            ...
            Intent intentContactPick = new Intent(NewCreateActivity.this, ContactsPickerActivity.class);
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults)
    {
        if (requestCode == PERMISSIONS_REQUEST_READ_CONTACTS)
        {
            ...
            {
                Toast.makeText(this, "Permission to access contact list not provided by you", Toast.LENGTH_SHORT).show();
            }
        }
                ...
                if (response.body() != null) {
                    if (response.code() == 200) {
                        if (response.body().getStatus().equalsIgnoreCase("true")) {
                            ...
                            binding.ivcreate.setEnabled(false);
                ...
                if (response.body() != null) {
                    if (response.code() == 200) {
                        if (response.body().getStatus().equalsIgnoreCase("true")) {
                            ...
                            binding.etEmail.setText(response.body().getJsonData().get(0).getCommunityName());
                            binding.etMobile.setText(response.body().getJsonData().get(0).getDescription());

                            extend_count=response.body().getJsonData().get(0).getCommunityId();
